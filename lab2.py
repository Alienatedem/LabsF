...
class SignalApp:
    def __init__(self, master):
        ...
        self.num_exp = 3          # Количество экспоненциальных членов
        self.num_cos = 1          # Количество косинусных членов
        self.num_log = 0          # Количество логарифмических членов
        self.amp_exp = [0.35, 0.25, 0.4] # Амплитуды для экспоненциальных членов
        self.amp_cos = [1]        # Амплитуды для косинусных членов
        self.amp_log = [0]      # Амплитуды для логарифмических членов
        ...
        self.total_duration = 30      # Общая продолжительность в секундах
